...
CREATE TABLE IF NOT EXISTS auth_users_and_roles (
  ...
  PRIMARY KEY(user_id, role_id)
	...
	BEGIN
	EXECUTE IMMEDIATE 'DROP TABLE auth_users_and_roles CASCADE CONSTRAINTS';
	...
	-- +gobatis StatementEnd
	-- +gobatis StatementBegin
	BEGIN EXECUTE IMMEDIATE 'DROP SEQUENCE  seq_users'; EXCEPTION WHEN OTHERS THEN IF SQLCODE != -942 THEN RAISE; END IF; END;
	-- +gobatis StatementEnd
	-- +gobatis StatementBegin
	BEGIN EXECUTE IMMEDIATE 'DROP SEQUENCE  seq_userprofiles'; EXCEPTION WHEN OTHERS THEN IF SQLCODE != -942 THEN RAISE; END IF; END;
	-- +gobatis StatementEnd
	-- +gobatis StatementBegin
	BEGIN EXECUTE IMMEDIATE 'DROP SEQUENCE  seq_auth_roles'; EXCEPTION WHEN OTHERS THEN IF SQLCODE != -942 THEN RAISE; END IF; END;
	-- +gobatis StatementEnd
	...
	CREATE TABLE auth_users (
	  id NUMBER(19) DEFAULT seq_users.NEXTVAL NOT NULL PRIMARY KEY,
	...
	CREATE SEQUENCE seq_userprofiles
	  INCREMENT BY 1
	  START WITH 1
	  NOMAXVALUE
	  NOMINVALUE
	...
	CREATE TABLE user_profiles (
	  id NUMBER(19) DEFAULT seq_userprofiles.NEXTVAL NOT NULL PRIMARY KEY,
	...
	CREATE SEQUENCE seq_auth_roles
	  INCREMENT BY 1
	  START WITH 1
	  NOMAXVALUE
	  NOMINVALUE
	...
	CREATE TABLE auth_roles (
	  id NUMBER(19) DEFAULT seq_auth_roles.NEXTVAL NOT NULL PRIMARY KEY,
