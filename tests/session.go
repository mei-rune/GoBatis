...
const (
	...
	OracleScript = `
-- ========================
-- DROP TABLES（19c 原生支持 IF EXISTS）
-- ========================
-- DROP TABLE IF EXISTS gobatis_user_and_groups;
-- DROP TABLE IF EXISTS gobatis_users;
-- DROP TABLE IF EXISTS gobatis_usergroups;
...
BEGIN EXECUTE IMMEDIATE 'DROP TABLE gobatis_user_and_groups'; EXCEPTION WHEN OTHERS THEN IF SQLCODE != -942 THEN RAISE; END IF; END;
BEGIN EXECUTE IMMEDIATE 'DROP TABLE gobatis_users'; EXCEPTION WHEN OTHERS THEN IF SQLCODE != -942 THEN RAISE; END IF; END;
BEGIN EXECUTE IMMEDIATE 'DROP TABLE gobatis_usergroups'; EXCEPTION WHEN OTHERS THEN IF SQLCODE != -942 THEN RAISE; END IF; END;
BEGIN EXECUTE IMMEDIATE 'DROP TABLE gobatis_settings'; EXCEPTION WHEN OTHERS THEN IF SQLCODE != -942 THEN RAISE; END IF; END;
BEGIN EXECUTE IMMEDIATE 'DROP TABLE gobatis_list'; EXCEPTION WHEN OTHERS THEN IF SQLCODE != -942 THEN RAISE; END IF; END;
BEGIN EXECUTE IMMEDIATE 'DROP TABLE gobatis_testa'; EXCEPTION WHEN OTHERS THEN IF SQLCODE != -942 THEN RAISE; END IF; END;
BEGIN EXECUTE IMMEDIATE 'DROP TABLE gobatis_testb'; EXCEPTION WHEN OTHERS THEN IF SQLCODE != -942 THEN RAISE; END IF; END;
BEGIN EXECUTE IMMEDIATE 'DROP TABLE gobatis_testc'; EXCEPTION WHEN OTHERS THEN IF SQLCODE != -942 THEN RAISE; END IF; END;
BEGIN EXECUTE IMMEDIATE 'DROP TABLE gobatis_teste1'; EXCEPTION WHEN OTHERS THEN IF SQLCODE != -942 THEN RAISE; END IF; END;
BEGIN EXECUTE IMMEDIATE 'DROP TABLE gobatis_teste2'; EXCEPTION WHEN OTHERS THEN IF SQLCODE != -942 THEN RAISE; END IF; END;
BEGIN EXECUTE IMMEDIATE 'DROP TABLE gobatis_testf1'; EXCEPTION WHEN OTHERS THEN IF SQLCODE != -942 THEN RAISE; END IF; END;
BEGIN EXECUTE IMMEDIATE 'DROP TABLE gobatis_testf2'; EXCEPTION WHEN OTHERS THEN IF SQLCODE != -942 THEN RAISE; END IF; END;
BEGIN EXECUTE IMMEDIATE 'DROP TABLE gobatis_convert1'; EXCEPTION WHEN OTHERS THEN IF SQLCODE != -942 THEN RAISE; END IF; END;
BEGIN EXECUTE IMMEDIATE 'DROP TABLE gobatis_convert2'; EXCEPTION WHEN OTHERS THEN IF SQLCODE != -942 THEN RAISE; END IF; END;
BEGIN EXECUTE IMMEDIATE 'DROP TABLE computers'; EXCEPTION WHEN OTHERS THEN IF SQLCODE != -942 THEN RAISE; END IF; END;
BEGIN EXECUTE IMMEDIATE 'DROP TABLE keyboards'; EXCEPTION WHEN OTHERS THEN IF SQLCODE != -942 THEN RAISE; END IF; END;
BEGIN EXECUTE IMMEDIATE 'DROP TABLE motherboards'; EXCEPTION WHEN OTHERS THEN IF SQLCODE != -942 THEN RAISE; END IF; END;
BEGIN EXECUTE IMMEDIATE 'DROP TABLE mouses'; EXCEPTION WHEN OTHERS THEN IF SQLCODE != -942 THEN RAISE; END IF; END;
...
CREATE TABLE gobatis_users (
  ...
  host_ip_ptr VARCHAR2(50),
  host_mac_ptr VARCHAR2(50),
  sex VARCHAR2(45),
  ...
  field4 FLOAT,
  field5 VARCHAR2(50),
  field6 TIMESTAMP  WITH TIME ZONE,
...
CREATE TABLE gobatis_user_and_groups (
  ...
  role_id NUMBER(10),
  CONSTRAINT chk_role_id CHECK (role_id > 0),
  PRIMARY KEY (user_id, group_id)
);
...
CREATE TABLE gobatis_settings (
  ...
  name VARCHAR2(45),
  value VARCHAR2(45),
  CONSTRAINT uk_gobatis_settings_name UNIQUE (name)
);

CREATE TABLE gobatis_list (
  id NUMBER(19) GENERATED BY DEFAULT AS IDENTITY PRIMARY KEY,
  name VARCHAR2(45),
  CONSTRAINT uk_gobatis_list_name UNIQUE (name)
);
...
CREATE TABLE gobatis_testb (
  id NUMBER(19) GENERATED BY DEFAULT AS IDENTITY PRIMARY KEY,
  field0 NUMBER(1) NOT NULL,
  field1 NUMBER(10) NOT NULL,
  field2 NUMBER(10) NOT NULL,
  field3 FLOAT NOT NULL,
  field4 FLOAT NOT NULL,
  field5 VARCHAR2(50) NOT NULL,
  field6 TIMESTAMP  WITH TIME ZONE NOT NULL,
  field7 VARCHAR2(50) NOT NULL,
  field8 VARCHAR2(50) NOT NULL,
  field9 CLOB
);
...
-- CLEAR DATA
-- ========================
DELETE FROM gobatis_user_and_groups;
DELETE FROM gobatis_users;
DELETE FROM gobatis_usergroups;
DELETE FROM gobatis_settings;
DELETE FROM gobatis_list;
DELETE FROM gobatis_testa;
DELETE FROM gobatis_testb;
DELETE FROM gobatis_testc;
DELETE FROM gobatis_teste1;
DELETE FROM gobatis_teste2;
DELETE FROM gobatis_testf1;
DELETE FROM gobatis_testf2;
DELETE FROM gobatis_convert1;
DELETE FROM gobatis_convert2;
