...
func init() {
	...
	dialects.SetHandleError(dialects.DriverPgx.Name(), handleError)
	dialects.SetHandleArray(dialects.DriverPgx.Name(), makePQArrayValuer(typeMap), makePQArrayScanner(typeMap))
}
