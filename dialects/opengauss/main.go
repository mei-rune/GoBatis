...
func init() {
	dialects.SetHandleError(dialects.DriverOpengauss.Name(), handleError)
	dialects.SetHandleArray(dialects.DriverOpengauss.Name(), makePQArrayValuer, makePQArrayScanner)
}
