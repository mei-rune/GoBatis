...
func NewMapperTagFunc(tagName string, mapFunc func(string) string, tagSplit func(string, string) []string) *Mapper {
	if tagSplit == nil {
		tagSplit = func(s string, fieldName string) []string {
